...
export function Notes(props : params){
    ...
    return <div className={`mx-10 flex justify-between items-center px-14 py-2 ${props.size<=768?'px-5 py-0.7 mx-2':''} h-auto bg-black rounded-full border border-gray-900 shadow shadow-gray-800 `}>
