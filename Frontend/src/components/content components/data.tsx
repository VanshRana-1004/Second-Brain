...
export function Data(props : params){
    return <div className={` h-full flex-1 flex-col p-10 pr-0 pl-24 gap-10 ${props.size<=768?'pl-14 ':''} overflow-y-auto scroll-smooth scrollbar-black your-scroll-container`}>
