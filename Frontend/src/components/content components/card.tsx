...
export function Card(props : params){
    ...
    return <div className={`border border-gray-800  rounded-xl h-[500px] w-[310px] m-auto ${props.size==380?'w-[290px]':''} bg-black px-3 py-3  flex flex-col overflow-hidden justify-around` }>
