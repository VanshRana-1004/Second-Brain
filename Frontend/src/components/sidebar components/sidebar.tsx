...
export function Sidebar(props : PropsType){
    ...
    return <div className={`z-50 overflow-visible top-0 left-0 flex  flex-col items-center gap-2 duration-200 ease-in-out min-h-screen border-r-2 border-r-gray-700  ${props.showInput?'opacity-25':'opacity-100'} ${style}  bg-black`}>
