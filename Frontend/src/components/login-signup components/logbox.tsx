...
export function SignUp_Login(props : params){
    ...
    return <div className={`bg-black border shadow-gray-500 shadow-md rounded-md h-[450px] w-96 ${props.size<=500?'w-72':''} flex flex-col pt-1 px-1 m-auto  items-center justify-between`}>
        <ToastContainer/>
